...
val SugarStitchColors = StitchPaletteColors(
    ...
    SurfaceLow = Color(0xFFFBF4EA),
    SurfaceContainer = Color(0xFFF9E8EE),
    SurfaceContainerHigh = Color(0xFFF2DDD9),
    OnSurface = Color(0xFF2B1722),
    OnSurfaceVariant = Color(0xCC2B1722),
    Brand = Color(0xFFCF2D56),
    BrandLight = Color(0xFFE77E96),
    BrandEnd = Color(0xFFCF2D56),
    BrandMuted = Color(0x1FCF2D56),
    PrimaryDark = Color(0xFF7F2038),
    Secondary = Color(0xFF2D8AA3),
    SecondaryContainer = Color(0x2E2D8AA3),
    Outline = Color(0x9959414D),
    OutlineVariant = Color(0x2459414D),
    Error = Color(0xFFBA1A1A),
    Gold = Color(0xFFC08532),
    GoldWeak = Color(0x2EC08532),
    HeaderBorder = Color(0x1FCF2D56),
